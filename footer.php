...
?>
	...
	echo stripslashes( $woo_options['woo_footer_right_text'] );
			...
			<p><?php _e( 'Powered by', 'woothemes' ) ?> <a href="http://www.wordpress.org">WordPress</a>. <?php _e( 'Designed by', 'woothemes' ) ?> <a href="http://www.tekpals.com"><img src="/ajbassets/tp-dark-footer-logo.png" width="87" height="21" alt="Tekpals" /></a></p>
		<?php } ?>
		</div>
